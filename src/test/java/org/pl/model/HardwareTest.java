...
class HardwareTest {
    ...
    void testEquals() {
        ...
        assertEquals(new Hardware(hardwareUUID,100, new Computer(DUSTY),false,  ""), hardware);
        assertNotEquals(new Hardware(newUUID,100, new Computer(DUSTY), true, ""), hardware);
        assertNotEquals(new Hardware(hardwareUUID,120, new Computer(DUSTY),false, ""), hardware);
        assertNotEquals(new Hardware(hardwareUUID,100, new Computer(FINE),false, ""), hardware);
        assertNotEquals(new Hardware(hardwareUUID,100, new Phone(DUSTY), false, ""), hardware);
    }
